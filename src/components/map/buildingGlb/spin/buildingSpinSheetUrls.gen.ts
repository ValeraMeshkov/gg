...
import spin_tower from "@/assets/buildings/spin-sheets/bashnya.png?url";
import spin_tower_alt from "@/assets/buildings/spin-sheets/bashnya2.png?url";
import spin_watchtower from "@/assets/buildings/spin-sheets/storozh.png?url";
...
import spin_shark from "@/assets/buildings/spin-sheets/akula.png?url";
...
export const SPIN_SHEET_URL_BY_GLB_FILE: Record<string, string> = {
  ...
  "tower-alt.glb": spin_tower_alt,
  "watchtower.glb": spin_watchtower,
