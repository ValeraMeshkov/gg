...
export const LEGACY_BUILDING_SKIN_MAP: Record<string, BuildingSkinId> = {
  ...
  pixellabsWatchtower: _legacyBuilding,
  pixellabsSignpost: _legacyBuilding,
  pixellabs3402: _legacyBuilding,
  freedomHouse: _legacyBuilding,
  tinyPlanetDefective: _legacyBuilding,
  tinyPlanetIcon: _legacyBuilding,
  tinyPlanetShield: _legacyBuilding,
  tinyPlanetStar: _legacyBuilding,
  freedomShark: _legacyBuilding,
  tinyPlanetBoy: _legacyBuilding,
  tinyPlanetEnergy: _legacyBuilding,
